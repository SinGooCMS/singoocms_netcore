...
{
    public class RadioButton : FieldControl
    {
        public RadioButton(ICMSContext _context, IAttachmentRepository _attachmentRepository, IDictItemRepository _dictItemRepository)
        {
        ...
        public override FieldType FieldType => FieldType.RadioButton;

        public override async Task<string> Render()
        {
            string path = $"/views/platform/{context.SiteConfig.Theme}/FieldControls/RadioButtonType.cshtml";
