...
namespace SinGooCMS.Cache.Redis
{
    /// <summary>
    /// Redis操作
    /// </summary>
    public class RedisHelper
    {
        ...
        public RedisHelper(int dbNum=0, string readWriteHosts=null)
        {
            DbNum = dbNum;
            _conn =
        ...
        public IList<RedisKey> KeyAll(string pattern="*",int dbNum=0,int pageSize=1000)
        {
            return _conn.GetServer(RedisConnectionHelper.RedisConnectionString.Split(',')[0]).Keys(dbNum, pattern, pageSize, CommandFlags.None).ToList<RedisKey>();
        }
